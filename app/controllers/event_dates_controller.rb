class EventDatesController < ApplicationController
  ...
  #     if @event_date.save
  #       format.html { redirect_to event_date_url(@event_date), notice: "Event date was successfully created." }
  ...
  #       format.html { redirect_to event_date_url(@event_date), notice: "Event date was successfully updated." }
  ...
  private
    ...
    def event_date_params
      params.require(:event_date).permit(:date, :location)
    end
end
